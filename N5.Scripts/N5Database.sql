...
CREATE DATABASE [N5]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'N5', FILENAME = N'E:\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\N5.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'N5_log', FILENAME = N'E:\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\N5_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
GO
ALTER TABLE [dbo].[Permissions]  WITH CHECK ADD  CONSTRAINT [FK_PermissionTypes_Permissions] FOREIGN KEY([TipoPermiso])
...
GO
INSERT INTO [dbo].[PermissionTypes] ([Descripcion]) VALUES ('Administrador')
GO
INSERT INTO [dbo].[PermissionTypes] ([Descripcion]) VALUES ('Consulta')
GO
INSERT INTO [dbo].[PermissionTypes] ([Descripcion]) VALUES ('Comercial')
GO